...
# CONSOLIDATE_FILE_NAME = "bidsheet_brass_consolidate"
...
#     """
#     Create Excel file with proper header structure and merged cells
#     """
#     wb = Workbook()
#     ws = wb.active
...
#     white_fill = PatternFill(start_color='A9A9A9', end_color='FFFFFF', fill_type='solid')  # White
...
#     # Add merged cell for common columns
#     common_start_col = current_col
#     common_end_col = current_col + len(CONSOLIDATED_COMMON_COLUMN_NAMES) - 1
#     ws.merge_cells(start_row=1, start_column=common_start_col, 
#                    end_row=1, end_column=common_end_col)
#     ws.cell(row=1, column=common_start_col, value=" ")
#     ws.cell(row=1, column=common_start_col).alignment = wrap_alignment
#     current_col = common_end_col + 1
    
#     # Add merged cells for each supplier with alternating background colors
...
#         supplier_end_col = current_col + len(supplier_columns) - 1
#         ws.merge_cells(start_row=1, start_column=supplier_start_col, 
#                        end_row=1, end_column=supplier_end_col)
#         supplier_cell = ws.cell(row=1, column=supplier_start_col, value=supplier_name)
#         supplier_cell.alignment = wrap_alignment
#         supplier_cell.fill = background_fill  # Apply alternating background color
        
#         # Apply same background color to all cells in the merged range
#         for col in range(supplier_start_col, supplier_end_col + 1):
#             ws.cell(row=1, column=col).fill = background_fill
            
#         current_col = supplier_end_col + 1
#         supplier_index += 1  # Increment supplier index for next iteration
    
#     # Row 2: Detailed column headers (no background colors)
#     current_col = 1
...
#     # Supplier column headers (no background colors)
#     for file_name in file_names:
#         supplier_columns = get_supplier_columns(file_name, suppliers_with_additional_info)
...
#     total_columns = len(CONSOLIDATED_COMMON_COLUMN_NAMES)
#     for file_name in file_names:
#         supplier_columns = get_supplier_columns(file_name, suppliers_with_additional_info)
...
#         Apply for all process cleaned files 
#     """
#     try: 
...
#  Bidsheet brass consolidation related new data 
...
# def create_consolidated_excel(consolidated_data, file_names, suppliers_with_additional_info):
#     """
#     Create Excel file with proper header structure and supplier name columns
#     """
#     wb = Workbook()
#     ws = wb.active
#     ws.title = "Consolidated Suppliers"
...
#     # Define styles
#     light_gray_fill = PatternFill(start_color='d3d3d3', end_color='D3D3D3', fill_type='solid')  # Light gray
#     white_fill = PatternFill(start_color='f1f1f1', end_color='f1f1f1', fill_type='solid')  # White
#     wrap_alignment = Alignment(horizontal='center', vertical='center', wrap_text=True)
    
#     # Create headers
#     current_col = 1
    
#     # Add common column headers first
#     for col_name in CONSOLIDATED_COMMON_COLUMN_NAMES:
#         header_cell = ws.cell(row=1, column=current_col, value=col_name)
#         header_cell.alignment = wrap_alignment
#         current_col += 1
    
#     # Add supplier columns with supplier name column before each supplier's data
#     supplier_index = 0
#     for file_name in file_names:
#         print("Supplier name related information------------------------------------------")
#         supplier_user_information = extract_supplier_name(file_name)
...
#         supplier_name_cell = ws.cell(row=1, column=current_col, value="Supplier Name")
#         supplier_name_cell.alignment = wrap_alignment
#         supplier_name_cell.fill = background_fill
#         current_col += 1
...
#         # Add supplier data with supplier name column
#         for file_name in file_names:
#             # Get supplier name
#             supplier_user_information = extract_supplier_name(file_name)
#             supplier_name = supplier_user_information[1]
...
#             # Add supplier name in the supplier name column
#             supplier_name_cell = ws.cell(row=row_num, column=current_col, value=supplier_name)
#             supplier_name_cell.alignment = Alignment(wrap_text=True, vertical='top')
#             current_col += 1
...
#     total_columns = len(CONSOLIDATED_COMMON_COLUMN_NAMES)
#     for file_name in file_names:
#         total_columns += 1  # Add 1 for supplier name column
#         supplier_columns = get_supplier_columns(file_name, suppliers_with_additional_info)
#         total_columns += len(supplier_columns)
...
# Valid supplier information count related functionality 
...
#     light_gray_fill = PatternFill(start_color='d3d3d3', end_color='D3D3D3', fill_type='solid')  # Light gray
#     white_fill = PatternFill(start_color='f1f1f1', end_color='f1f1f1', fill_type='solid')  # White
#     pink_fill = PatternFill(start_color='90EE90', end_color='90EE90', fill_type='solid')  # Pink color for valid supplier > 0
#     wrap_alignment = Alignment(horizontal='center', vertical='center', wrap_text=True)
...
#     # Add Valid Supplier column after common columns
#     valid_supplier_cell = ws.cell(row=1, column=current_col, value="Valid Supplier")
#     valid_supplier_cell.alignment = wrap_alignment
#     valid_supplier_cell.fill = PatternFill(start_color='90EE90', end_color='90EE90', fill_type='solid')  # Light green
#     valid_supplier_column_index = current_col  # Store the column index for later use
#     current_col += 1
...
#         # Add Valid Supplier count with conditional pink highlighting
#         valid_supplier_count = count_valid_suppliers(row_data, file_names, suppliers_with_additional_info)
#         valid_supplier_cell = ws.cell(row=row_num, column=current_col, value=valid_supplier_count)
#         valid_supplier_cell.alignment = Alignment(wrap_text=True, vertical='top')
        
#         # Highlight cell with pink color if valid supplier count > 0
#         if valid_supplier_count > 0:
#             valid_supplier_cell.fill = pink_fill
