...
CLEANED_FILES_FOLDER_LOCATION = "./cleaned_files/bidsheet_steel"
CONSOLIDATED_FILE_LOCATION = "./consolidate"
CONSOLIDATE_FILE_NAME = "bidsheet_steel_consolidate"
...
for item in files: 
    ...
    # Read Excel file
    df = pd.read_excel(f"./files/{item}", "2. Bidsheet Steel", header=None)
